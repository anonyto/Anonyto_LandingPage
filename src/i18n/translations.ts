  ...
  fr: {
    ...
    hero: {
      ...
      newsletter: {
        ...
        subtitle:
          "Abonnez-vous pour recevoir les mises à jour, l'accès anticipé et les insights de sécurité.",
        placeholder: "Entrez votre email professionnel...",
        button: "Rejoindre la liste d'attente",
        microcopy:
          "Pas de spam. Uniquement des mises à jour importantes et des alertes de sortie.",
      },
    },
    problem: {
      title:
    ...
    howItWorks: {
      ...
      step3: {
        ...
        desc: "Noms, données clients, processus internes, chiffres, documents, infos financières, tout est masqué ou remplacé.",
      },
      step4: {
        title: "Le texte nettoyé est envoyé",
        desc: "Les outils IA reçoivent une version sûre et non identifiable.",
      },
      result:
        "Résultat : Vos données ne quittent jamais votre entreprise exposées.",
    },
    stats: {
    ...
    security: {
      title: "Vos données en toute sécurité",
      subtitle:
    ...
    integrations: {
      title: "Fonctionne avec tous vos outils IA",
      subtitle:
        "Compatible avec ChatGPT, Copilot, Gemini et tous les outils IA basés sur navigateur ou desktop",
    ...
    faq: {
      ...
      q3: {
        q: "La configuration est-elle difficile ?",
  ...
  en: {
    ...
    hero: {
      ...
      newsletter: {
        ...
        microcopy: "No spam. Only important updates and release alerts.",
      },
    },
    problem: {
    ...
    howItWorks: {
      ...
      step3: {
        ...
        desc: "Names, client data, internal processes, numbers, documents, financial info, all masked or replaced.",
      },
      step4: {
        title: "The cleaned text is sent",
        desc: "AI tools receive a safe, non-identifying version.",
      },
      result: "Result: Your data never leaves your company exposed.",
    },
    stats: {
    ...
    security: {
      ...
      subtitle: "Simple, secure, reliable. We protect what matters most.",
    ...
    integrations: {
      title: "Works With All Your AI Tools",
      subtitle:
        "Compatible with ChatGPT, Copilot, Gemini, and any browser-based or desktop AI tool",
